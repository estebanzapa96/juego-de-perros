...
public class principal {
    public static void main(String[] args) {
        ...
        System.out.println(optimus.getNombre() + " tiene una vida de: " + optimus.getSalud());
        System.out.println(holly.getNombre() + " tiene una vida de: " + holly.getSalud());
        System.out.println(chacha.getNombre() + " tiene una vida de: " + chacha.getSalud());
        System.out.println(yaqui.getNombre() + " tiene una vida de: " + yaqui.getSalud());
        System.out.println();
        ...
        do {
            ...
            System.out.println(optimus.getNombre() + " ha realizado un ataque de " + daño + " a chacha");
            chacha.daño(daño);
            ...
            System.out.println(chacha.getNombre() + " ha realizado un ataque de " + daño + " a optimus");
            optimus.daño(daño);
            ...
            System.out.println(holly.getNombre() + " ha realizado un ataque de " + daño + " a yaqui");
            yaqui.daño(daño);

            if (yaqui.getSalud() > 0) {
                aleatorio = rand.nextInt(1);
                if (aleatorio <= 0) {
                    daño = yaqui.ataque_fisico();
                } else {
                    daño = yaqui.ataque_mordida();
                }

                System.out.println(yaqui.getNombre() + " ha realizado un ataque de " + daño + " holly");
                holly.daño(daño);
            }
                /*
                 * aleatorio = rand.nextInt(1);
